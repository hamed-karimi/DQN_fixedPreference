...
class ObjectFactory:
    ...
    def get_agent(self, pre_location, preassigned_preference):
        agent = Agent(self.params.HEIGHT, self.params.WIDTH, n=self.params.OBJECT_TYPE_NUM,
                      lambda_preference=self.params.NEED_INCREASE,
                      prob_init_needs_equal=self.params.PROB_OF_INIT_NEEDS_EQUAL, predefined_location=pre_location,
                      preassigned_preferences=preassigned_preference, lambda_satisfaction=self.params.LAMBDA_SATISFACTION,
